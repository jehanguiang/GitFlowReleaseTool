...
public class Commit {
    ...
    public Commit(String workspace, String repo, String masterBranch, String developBranch, String prefix) {
    ...
    public List<String> getUniqueCommits() {
        List<String> commitsFromDevelop = getCommits(this.developBranch);
        List<String> commitsFromMaster = getCommits(this.masterBranch);
    ...
    private String trimCommitMessages(String message) {
        return message.substring(message.indexOf(this.prefix)+1).replace("\n", "");
    }
